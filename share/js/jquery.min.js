...
(function(e, t) {
    ...
    x.support = function(t) {
        ...
        t.shtmlSerialize = !!d.getElementsByTagName("link").length,
        ...
        t.shtml5Clone = "<:nav></:nav>" !== a.createElement("nav").cloneNode(!0).outerHTML,
    ...
    var ht = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video"
      ...
      , At = {
        ...
        _default: x.support.shtmlSerialize ? [0, "", ""] : [1, "X<div>", "</div>"]
    }
      , jt = dt(a)
    ...
    x.fn.extend({
        ...
        html: function(e) {
            return x.access(this, function(e) {
                ...
                if (!("string" != typeof e || Tt.test(e) || !x.support.shtmlSerialize && mt.test(e) || !x.support.leadingWhitespace && yt.test(e) || At[(bt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(vt, "<$1></$2>");
                    try {
                        for (; i > r; r++)
                            n = this[r] || {},
    ...
    function Ot(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            x.support.shtml5Clone && e.innerHTML && !x.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && Ct.test(e.type) ? (t.defaultChecked = t.checked = e.checked,
    ...
    x.extend({
        clone: function(e, t, n) {
            ...
            if (x.support.shtml5Clone || x.isXMLDoc(e) || !mt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Dt.innerHTML = e.outerHTML,
    ...
    x.fn.load = function(e, n, r) {
        ...
        s.length > 0 && x.ajax({
            ...
            o = arguments,
            s.shtml(i ? x("<div>").append(x.parseHTML(e)).find(i) : e)
