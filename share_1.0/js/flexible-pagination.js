...
Flexible.Pagination = function(options){
    ...
    defaultOption.btnFirstText = "<i class='fas fa-step-backward'></i>";
    defaultOption.btnLastText = "<i class='fas fa-step-forward'></i>";
    defaultOption.btnNextText = "<i class='fas fa-angle-right'></i>";
    defaultOption.btnPreviousText = "<i class='fas fa-angle-left'></i>";
